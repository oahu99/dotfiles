(custom-set-variables
 ...
 ;; ^^^ Emacs theme color variable definitions END ^^^
 ;; -----------------------------------------------------------
 ;; vvv org variable definitions BEGIN vvv
...
(file "GRE-vocab.org"))))
 ...
 '(package-selected-packages
   '(org-page org2blog sx org-tree-slide org-fragtog windresize ## jupyter solarized-theme auctex expand-region emms use-package adaptive-wrap org term-keys multiple-cursors))
